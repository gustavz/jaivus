...
SUPPORTED_RECOGNIZER = ['google', 'whisper', 'google_cloud', 'sphinx', 'wit', 'azure', 'bing', 'lex', 'houndify', 'amazon', 'ibm', 'tensorflow', 'assemblyai', 'vosk']
...
class SpeechRecognizer:
    ...
    def listen(self):
        ...
        try:
            t = time.time()
            text = getattr(self.recognizer, self.recognizer_function_name)(audio, **self.kwargs)
